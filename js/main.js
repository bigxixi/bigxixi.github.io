...
;(function(window) {
	...
	GridFx.prototype._setOriginal = function(src) {
		if( !src ) {
			this.originalImg = document.createElement('video');
			this.originalImg.className = 'original';
			this.originalImg.id = 'video';
			this.originalImg.autoplay = 'autoplay';
			this.originalImg.muted = 'muted';
			//this.originalImg.preload = 'auto';
			this.originalImg.loop = 'loop';
